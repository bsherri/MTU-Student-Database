...
/*
The ViewStudentProfile class is used to display the profile of a selected student, including the student's name, an image,
and a table of the student's modules with module numbers, module names, semesters, and grades.
The profile includes the selected student's name, an image, and a table of modules for the student retrieved from the module table of the connected database.
The class also includes methods to update and delete module information, and to add new module information to the database.
 */
...
public class ViewStudentProfile {
   ...
   public static void display(Student selectedStudent) throws FileNotFoundException {
      ...
      try {
         ...
         TableColumn<Module, String> nameCol = new TableColumn<>("Module Name");
